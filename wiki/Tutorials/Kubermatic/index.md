...
>[!NOTE] 
> ```If you can`t access your existing cluster via kubectl, please take a look on the following chapter Fix k8s-ClusterAccess with Role Based Access Control (RBAC) after LifescienceAAI migration```
