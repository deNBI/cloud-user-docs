...
>[!NOTE] 
> ```If you can`t access your exisiting cluste, please take a look on the following chapter <strong>Fix k8s-ClusterAccess with Role Based Access Control (RBAC) after LifescienceAAI migration</strong>```
