...
~~~BASH
docker run -it -v "$(pwd):/srv_root/docs"  -p "8000:8000" --env ENABLED_HTMLPROOFER=True --entrypoint="mkdocs" docs serve -f /srv_root/docs/config.yml   --dev-addr 0.0.0.0:8000
~~~
